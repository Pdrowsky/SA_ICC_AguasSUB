...
diretorio_graficos = os.chdir(r'P:\PETROBRAS-0902-ICC-Qualidade da Água 2021\BancoDados\Figuras\AguaSup\C33')



ax=dados_od.iloc[:,1:13].plot(subplots=True,layout=(12,3), figsize=(20,40), style=['.-', '.-', '.-','.-','.-','.-','.-','.-','.-','.-','.-','.-'], ylabel='OD (mg/L)')
plt.savefig('Serie_od1.png', bbox_inches='tight')
ax=dados_od.iloc[:,14:22].plot(subplots=True,layout=(12,3), figsize=(20,40), style=['.-', '.-', '.-','.-','.-','.-','.-','.-','.-','.-','.-','.-'], ylabel='OD (mg/L)')
plt.savefig('Serie_od2.png', bbox_inches='tight')

#Plota gráficos Condutividade
ax=dados_condutiv.iloc[:,1:13].plot(subplots=True,layout=(12,3), figsize=(20,40), style=['.-', '.-', '.-','.-','.-','.-','.-','.-','.-','.-','.-','.-'], ylabel='Condutividade Elétrica (µS/cm)')
plt.savefig('P:\PETROBRAS\902_ICC_QUALIDADE_DA_AGUA_2021\BancoDados\Figuras\AguaSup\C33\Serie_condutiv1.png', bbox_inches='tight')
ax=dados_condutiv.iloc[:,14:22].plot(subplots=True,layout=(12,3), figsize=(20,40), style=['.-', '.-', '.-','.-','.-','.-','.-','.-','.-','.-','.-','.-'], ylabel='Condutividade Elétrica (µS/cm)')
plt.savefig('P:\PETROBRAS\902_ICC_QUALIDADE_DA_AGUA_2021\BancoDados\Figuras\AguaSup\C33\Serie_condutiv2.png', bbox_inches='tight')
...
plt.savefig('P:\PETROBRAS\902_ICC_QUALIDADE_DA_AGUA_2021\BancoDados\Figuras\AguaSup\C33\Serie_Aluminio1.png', bbox_inches='tight')
ax=dados_aluminio.iloc[:,14:22].plot(subplots=True,layout=(12,3), figsize=(20,40), style=['.-', '.-', '.-','.-','.-','.-','.-','.-','.-','.-','.-','.-'], ylabel='Alumínio (mg/L)')
plt.savefig('P:\PETROBRAS\902_ICC_QUALIDADE_DA_AGUA_2021\BancoDados\Figuras\AguaSup\C33\Serie_Aluminio2.png', bbox_inches='tight')

#Plota gráficos Ferro
ax=dados_ferro.iloc[:,1:13].plot(subplots=True,layout=(12,3), figsize=(20,40), style=['.-', '.-', '.-','.-','.-','.-','.-','.-','.-','.-','.-','.-'], ylabel='Ferro (mg/L)')
plt.savefig('P:\PETROBRAS\902_ICC_QUALIDADE_DA_AGUA_2021\BancoDados\Figuras\AguaSup\C33\Serie_ferro1.png', bbox_inches='tight')
ax=dados_ferro.iloc[:,14:22].plot(subplots=True,layout=(12,3), figsize=(20,40), style=['.-', '.-', '.-','.-','.-','.-','.-','.-','.-','.-','.-','.-'], ylabel='Ferro (mg/L)')
plt.savefig('P:\PETROBRAS\902_ICC_QUALIDADE_DA_AGUA_2021\BancoDados\Figuras\AguaSup\C33\Serie_ferro2.png', bbox_inches='tight')
...
plt.savefig('P:\PETROBRAS\902_ICC_QUALIDADE_DA_AGUA_2021\BancoDados\Figuras\AguaSup\C33\Serie_manganes1.png', bbox_inches='tight')
ax=dados_manganes.iloc[:,14:22].plot(subplots=True,layout=(12,3), figsize=(20,40), style=['.-', '.-', '.-','.-','.-','.-','.-','.-','.-','.-','.-','.-'], ylabel='Manganês (mg/L)')
plt.savefig('P:\PETROBRAS\902_ICC_QUALIDADE_DA_AGUA_2021\BancoDados\Figuras\AguaSup\C33\Serie_manganes2.png', bbox_inches='tight')
...
plt.savefig('P:\PETROBRAS\902_ICC_QUALIDADE_DA_AGUA_2021\BancoDados\Figuras\AguaSup\C33\Serie_acidez1.png', bbox_inches='tight')
ax=dados_acidez.iloc[:,14:22].plot(subplots=True,layout=(12,3), figsize=(20,40), style=['.-', '.-', '.-','.-','.-','.-','.-','.-','.-','.-','.-','.-'], ylabel='Acidez Total (mg/L)')
plt.savefig('P:\PETROBRAS\902_ICC_QUALIDADE_DA_AGUA_2021\BancoDados\Figuras\AguaSup\C33\Serie_acidez2.png', bbox_inches='tight')


#Plota gráficos Sulfato
ax=dados_sulfato.iloc[:,1:13].plot(subplots=True,layout=(12,3), figsize=(20,40), style=['.-', '.-', '.-','.-','.-','.-','.-','.-','.-','.-','.-','.-'], ylabel='Sulfato (mg/L)')
plt.savefig('P:\PETROBRAS\902_ICC_QUALIDADE_DA_AGUA_2021\BancoDados\Figuras\AguaSup\C33\Serie_sulfato1.png', bbox_inches='tight')
ax=dados_sulfato.iloc[:,14:22].plot(subplots=True,layout=(12,3), figsize=(20,40), style=['.-', '.-', '.-','.-','.-','.-','.-','.-','.-','.-','.-','.-'], ylabel='Sulfato (mg/L)')
plt.savefig('P:\PETROBRAS\902_ICC_QUALIDADE_DA_AGUA_2021\BancoDados\Figuras\AguaSup\C33\Serie_sulfato2.png', bbox_inches='tight')


#Plota gráficos pH
ax=dados_ph.iloc[:,1:13].plot(subplots=True,layout=(12,3), figsize=(20,40), style=['.-', '.-', '.-','.-','.-','.-','.-','.-','.-','.-','.-','.-'], ylabel='pH')
plt.savefig('P:\PETROBRAS\902_ICC_QUALIDADE_DA_AGUA_2021\BancoDados\Figuras\AguaSup\C33\Serie_pH1.png', bbox_inches='tight')
ax=dados_ph.iloc[:,14:22].plot(subplots=True,layout=(12,3), figsize=(20,40), style=['.-', '.-', '.-','.-','.-','.-','.-','.-','.-','.-','.-','.-'], ylabel='pH')
plt.savefig('P:\PETROBRAS\902_ICC_QUALIDADE_DA_AGUA_2021\BancoDados\Figuras\AguaSup\C33\Serie_pH2.png', bbox_inches='tight')
...
ASIC34_al = dados_aluminio['ASIC3/4']
...
ax.plot(ASIC34_al, '.-', label='ASIC3/4')
...
ax.grid()
plt.savefig('P:\PETROBRAS\902_ICC_QUALIDADE_DA_AGUA_2021\BancoDados\Figuras\AguaSup\C33\Conjuntos_aluminio.png', bbox_inches='tight', dpi=300)

#Plota Gráfico principais poços dos conjuntos - Ferro

ASIC1_fe = dados_ferro['ASIC1']
ASIC10_fe = dados_ferro['ASIC10']
ASIC34_fe = dados_ferro['ASIC3/4']
...
ax.plot(ASIC34_fe, '.-', label='ASIC3/4')
...
plt.savefig('P:\PETROBRAS\902_ICC_QUALIDADE_DA_AGUA_2021\BancoDados\Figuras\AguaSup\C33\Conjuntos_ferro.png', bbox_inches='tight', dpi=300)

#Plota Gráfico principais poços dos conjuntos - Manganês

ASIC1_mg = dados_manganes['ASIC1']
ASIC10_mg = dados_manganes['ASIC10']
ASIC34_mg = dados_manganes['ASIC3/4']
...
ax.plot(ASIC34_mg, '.-', label='ASIC3/4')
...
plt.savefig('P:\PETROBRAS\902_ICC_QUALIDADE_DA_AGUA_2021\BancoDados\Figuras\AguaSup\C33\Conjuntos_manganes.png', bbox_inches='tight', dpi=300)

#Plota Gráfico principais poços dos conjuntos - Acidez

ASIC1_ac = dados_acidez['ASIC1']
ASIC10_ac = dados_acidez['ASIC10']
ASIC34_ac = dados_acidez['ASIC3/4']
...
ax.plot(ASIC34_ac, '.-', label='ASIC3/4')
...
plt.savefig('P:\PETROBRAS\902_ICC_QUALIDADE_DA_AGUA_2021\BancoDados\Figuras\AguaSup\C33\Conjuntos_acidez.png', bbox_inches='tight', dpi=300)

#Plota Gráfico principais poços dos conjuntos - Sulfato

ASIC1_so = dados_sulfato['ASIC1']
ASIC10_so = dados_sulfato['ASIC10']
ASIC34_so = dados_sulfato['ASIC3/4']
...
ax.plot(ASIC34_so, '.-', label='ASIC3/4')
...
plt.savefig('P:\PETROBRAS\902_ICC_QUALIDADE_DA_AGUA_2021\BancoDados\Figuras\AguaSup\C33\Conjuntos_sulfato.png', bbox_inches='tight', dpi=300)

#Plota Gráfico principais poços dos conjuntos - pH

ASIC1_ph = dados_ph['ASIC1']
ASIC10_ph = dados_ph['ASIC10']
ASIC34_ph = dados_ph['ASIC3/4']
...
ax.plot(ASIC34_ph, '.-', label='ASIC3/4')
...
plt.savefig('P:\PETROBRAS\902_ICC_QUALIDADE_DA_AGUA_2021\BancoDados\Figuras\AguaSup\C33\Conjuntos_pH.png', bbox_inches='tight', dpi=300)
...
ASIC34_condutiv = dados_condutiv['ASIC3/4']
...
ax.plot(ASIC34_condutiv, '.-', label='ASIC3/4')
...
plt.savefig('P:\PETROBRAS\902_ICC_QUALIDADE_DA_AGUA_2021\BancoDados\Figuras\AguaSup\C33\Conjuntos_condutiv.png', bbox_inches='tight', dpi=300)
#Gráficos das Cargas

ASIC1_cacidez = dados_cargasacidez['ASIC1']
ASIC10_cacidez = dados_cargasacidez['ASIC10']
ASIC34_cacidez = dados_cargasacidez['ASIC3/4']
...
ax.plot(ASIC34_cacidez, '.-', label='ASIC3/4')
...
plt.savefig('P:\PETROBRAS\902_ICC_QUALIDADE_DA_AGUA_2021\BancoDados\Figuras\AguaSup\C33\Cargas_Acidez.png', bbox_inches='tight', dpi=300)

ASIC1_caluminio = dados_cargasaluminio['ASIC1']
ASIC10_caluminio = dados_cargasaluminio['ASIC10']
ASIC34_caluminio = dados_cargasaluminio['ASIC3/4']
...
ax.plot(ASIC34_caluminio, '.-', label='ASIC3/4')
ax.plot(ASIC17_caluminio, '.-', label='ASIC 17')
ax.set_yscale('log')
plt.legend(loc = "lower left")
leg = ax.legend()

plt.legend(loc="lower left", ncol = 2) #expand stretches it along the bottom # while ncol specifies the number of columns
ax.set(xlabel='Ano', ylabel='Carga Alumínio(kg/h)')
ax.grid()

plt.savefig('P:\PETROBRAS\902_ICC_QUALIDADE_DA_AGUA_2021\BancoDados\Figuras\AguaSup\C33\Cargas_Aluminio.png', bbox_inches='tight', dpi=300)

ASIC1_cferro = dados_cargasferro['ASIC1']
ASIC10_cferro = dados_cargasferro['ASIC10']
ASIC34_cferro = dados_cargasferro['ASIC3/4']
...
ax.plot(ASIC34_cferro, '.-', label='ASIC3/4')
...
plt.savefig('P:\PETROBRAS\902_ICC_QUALIDADE_DA_AGUA_2021\BancoDados\Figuras\AguaSup\C33\Cargas_Ferro.png', bbox_inches='tight', dpi=300)

ASIC1_cmanganes = dados_cargasmanganes['ASIC1']
ASIC10_cmanganes = dados_cargasmanganes['ASIC10']
ASIC34_cmanganes = dados_cargasmanganes['ASIC3/4']
...
ax.plot(ASIC34_cmanganes, '.-', label='ASIC3/4')
...
plt.savefig('P:\PETROBRAS\902_ICC_QUALIDADE_DA_AGUA_2021\BancoDados\Figuras\AguaSup\C33\Cargas_Manganes.png', bbox_inches='tight', dpi=300)


ASIC1_csulfato = dados_cargassulfato['ASIC1']
ASIC10_csulfato = dados_cargassulfato['ASIC10']
ASIC34_csulfato = dados_cargassulfato['ASIC3/4']
...
ax.plot(ASIC34_csulfato, '.-', label='ASIC3/4')
...
plt.savefig('P:\PETROBRAS\902_ICC_QUALIDADE_DA_AGUA_2021\BancoDados\Figuras\AguaSup\C33\Cargas_Sulfato.png', bbox_inches='tight', dpi=300)
...
plt.legend(bbox_to_anchor=(1.0,0.5), loc="center left", ncol=1) #expand stretches it along the bottom # while ncol specifies the number of columns
ax.set(xlabel='Ano', ylabel='Cargas (kg/h)')
ax.grid()

plt.savefig('P:\PETROBRAS\902_ICC_QUALIDADE_DA_AGUA_2021\BancoDados\Figuras\AguaSup\C33\Cargas_DAM.png', bbox_inches='tight', dpi=300)
...
plt.savefig('P:\PETROBRAS\902_ICC_QUALIDADE_DA_AGUA_2021\BancoDados\Figuras\AguaSub\C30\Multinivel_aluminio.png', bbox_inches='tight', dpi=300)
...
plt.savefig('P:\PETROBRAS\902_ICC_QUALIDADE_DA_AGUA_2021\BancoDados\Figuras\AguaSub\C30\Multinivel_ferro.png', bbox_inches='tight', dpi=300)
...
plt.savefig('P:\PETROBRAS\902_ICC_QUALIDADE_DA_AGUA_2021\BancoDados\Figuras\AguaSub\C30\Multinivel_manganes.png', bbox_inches='tight', dpi=300)
...
plt.savefig('P:\PETROBRAS\902_ICC_QUALIDADE_DA_AGUA_2021\BancoDados\Figuras\AguaSub\C30\Multinivel_acidez.png', bbox_inches='tight', dpi=300)
...
plt.savefig('P:\PETROBRAS\902_ICC_QUALIDADE_DA_AGUA_2021\BancoDados\Figuras\AguaSub\C30\Multinivel_sulfato.png', bbox_inches='tight', dpi=300)
...
plt.savefig('P:\PETROBRAS\902_ICC_QUALIDADE_DA_AGUA_2021\BancoDados\Figuras\AguaSub\C30\Multinivel_ph.png', bbox_inches='tight', dpi=300)


#Dados por Campanha

dados_C29 = pd.read_excel(r"P:\PETROBRAS\902_ICC_QUALIDADE_DA_AGUA_2021\BancoDados\ICC_AguaSub_Campanhas.xlsx", sheet_name='C29')
...
ax[1].bar(pocos[4:7], ph_c29[4:7], color = '#4e2d6e', label='Conj. 2', width=0.5)
ax[2].bar(pocos[7:10], ph_c29[7:10], color = '#802f75', label='Conj. 3', width=0.5)
ax[3].bar(pocos[10:14], ph_c29[10:14], color = '#af3271', label='Conj. 4', width=0.5)
ax[4].bar(pocos[14:16], ph_c29[14:16], color = '#d73e63', label='Conj. 5', width=0.5)
ax[5].bar(pocos[16:17], ph_c29[16:17], color = '#f2594e', label='Conj. 6', width=0.5)
ax[6].bar(pocos[17:20], ph_c29[17:20], color = '#ff7d33', label='Conj. 7', width=0.5)
ax[7].bar(pocos[20:24], ph_c29[20:24], color = '#ffa600', label='Conj. 8', width=0.5)  
ax[8].bar(pocos[24:34], ph_c29[24:34], color = '#ecff00', label='Conj. 9', width=0.5) 
...
plt.savefig('P:\PETROBRAS\902_ICC_QUALIDADE_DA_AGUA_2021\BancoDados\Figuras\AguaSub\c29_pH.png', bbox_inches='tight', dpi=300)
...
heights = [1]
spec5 = fig5.add_gridspec(ncols=9, nrows=1, width_ratios=widths, height_ratios=heights)
...
ax2.bar(pocos[4:7], ph_c28[4:7], color = '#4e2d6e', label='Conj. 2', width=0.5)
ax3 = fig5.add_subplot(spec5[0,2], sharey=ax1)
plt.setp(ax3.get_yticklabels(), visible=False)
ax3.bar(pocos[7:10], ph_c28[7:10], color = '#802f75', label='Conj. 3', width=0.5)
ax4 = fig5.add_subplot(spec5[0,3], sharey=ax1)       
plt.setp(ax4.get_yticklabels(), visible=False)
ax4.bar(pocos[10:14], ph_c28[10:14], color = '#af3271', label='Conj. 4', width=0.5)
ax5 = fig5.add_subplot(spec5[0,4], sharey=ax1)
plt.setp(ax5.get_yticklabels(), visible=False)
ax5.bar(pocos[14:16], ph_c28[14:16], color = '#d73e63', label='Conj. 5', width=0.5)

ax6 = fig5.add_subplot(spec5[0,5], sharey=ax1)
plt.setp(ax6.get_yticklabels(), visible=False)
ax6.bar(pocos[16:17], ph_c28[16:17], color = '#f2594e', label='Conj. 6', width=0.1)

ax7 = fig5.add_subplot(spec5[0,6], sharey=ax1)
plt.setp(ax7.get_yticklabels(), visible=False)
ax7.bar(pocos[17:20], ph_c28[17:20], color = '#ff7d33', label='Conj. 7', width=0.5)
ax8 = fig5.add_subplot(spec5[0,7], sharey=ax1)
plt.setp(ax8.get_yticklabels(), visible=False)
ax8.bar(pocos[20:24], ph_c28[20:24], color = '#ffa600', label='Conj. 8', width=0.5)  
ax9 = fig5.add_subplot(spec5[0,8], sharey=ax1)
plt.setp(ax9.get_yticklabels(), visible=False)
ax9.bar(pocos[24:34], ph_c28[24:34], color = '#ecff00', label='Conj. 9', width=0.5)        
#plt.show()

plt.savefig('P:\PETROBRAS\902_ICC_QUALIDADE_DA_AGUA_2021\BancoDados\Figuras\AguaSub\c28_pH.png', bbox_inches='tight', dpi=300)
