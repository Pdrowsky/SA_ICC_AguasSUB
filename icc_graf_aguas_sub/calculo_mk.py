...
def tendencia_ph(
        lista):  # roda com -> tendencia_ph2('PMI-02', 'PMI-04', 'PMI-08', etc)
...
def tendencia_mn_aluminio(lista):
    # inserir local onde a planilha será criada
    # filepath = ""
    wb1 = openpyxl.Workbook()
    sheet1 = wb1['Sheet']
